    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(StudentProfileActivity.this,LoginAll.class);
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.navigation_feed_student:
                                Intent intentnotice=new Intent(StudentProfileActivity.this, StudentNoticeListActivity.class);
                                startActivity(intentnotice);
                                break;
                            case R.id.navigation_profile_student:
                                Intent intentProfile=new Intent(StudentProfileActivity.this, StudentProfileActivity.class);
