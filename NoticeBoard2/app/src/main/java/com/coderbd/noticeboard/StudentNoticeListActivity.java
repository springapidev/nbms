                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.navigation_feed_student:
                                Intent intentnotice=new Intent(StudentNoticeListActivity.this, StudentNoticeListActivity.class);
                                startActivity(intentnotice);
                                break;
                            case R.id.navigation_profile_student:
                                Intent intentProfile=new Intent(StudentNoticeListActivity.this,StudentProfileActivity.class);
            ...
            FirebaseDatabase.getInstance().getReference().child("Users").child(firebaseUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        adapter = new NoticeAdapter(StudentNoticeListActivity.this, noticeListByDepAndIns);
